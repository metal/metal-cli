...
module.exports = {
  ...
  d: {
      alias: 'dest',
      default: [metalToolsBuildGlobalsOptions.dest],
  ...
  b: {
      ...
      describe: 'The name of the final bundle file, for formats (like "globals") that create one.',
      type: 'string'
  },
  g: {
      alias: 'globalName',
      default: metalToolsBuildGlobalsOptions.globalName,
      describe: 'Only used by the "globals" format build. The name of the global variable that will hold exported modules.',
      type: 'string'
  }
};
